...
"""
import os
from overcook_gym_env import ComplexOvercookedGridworld
...
class LlmMediumLevelAgent():
	...
	def create_gptmodule(self, module_name, file_type='txt', retrival_method='recent_k', K=10):
		...
		prompt_file = os.path.join(PROMPT_DIR, self.layout)
	...
	def generate_layout_prompt(self):
		layout_prompt_dict = {
			"BClemon_dispenser": " <BClemon Dispenser {id}>",
			"AClemon_dispenser": " <AClemon Dispenser {id}>",
