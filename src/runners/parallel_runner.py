            ...
            for idx, parent_conn in enumerate(self.parent_conns):
                if not terminated[idx]:
                    ...
                    if test_mode:
                        ...
                        post_transition_data["reward"].append((data["info"]["sparse_r"] + data["info"]["shaped_r"]* self.reward_shaping_factor,))
                        episode_returns[idx] += data["info"]["sparse_r"] + data["info"]["shaped_r"]* self.reward_shaping_factor
