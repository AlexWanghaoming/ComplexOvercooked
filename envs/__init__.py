...
from .overcooked2_wrapper import Overcooked2Wrapper
...
def overcooked2_fn(**kwargs) -> MultiAgentEnv:
    assert "common_reward" in kwargs and "reward_scalarisation" in kwargs
    # print("kwargs", kwargs)
    return Overcooked2Wrapper(**kwargs)


REGISTRY = {}
# REGISTRY["smaclite"] = smaclite_fn
REGISTRY["gymma"] = gymma_fn
REGISTRY["overcooked2"] = overcooked2_fn
